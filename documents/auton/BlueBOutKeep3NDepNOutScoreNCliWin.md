# Auton: BlueBOutKeep3NDepNOutScoreNCliWin

> Auto-generated from [`src/main/deploy/auton/BlueBOutKeep3NDepNOutScoreNCliWin.xml`](../../src/main/deploy/auton/BlueBOutKeep3NDepNOutScoreNCliWin.xml).  
...
stateDiagram-v2
    ...
    Step4 --> Step5: "launcher=PREPARE_TO_LAUNCH"
    ...
    Step8 --> [*]: "launcher=PREPARE_TO_LAUNCH"
```
...
| 2 | TRAJECTORY_DRIVE | [BlueMRDrop3_A](../../src/main/deploy/choreo/BlueMRDrop3_A.traj) | 3.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | -- |
...
| 4 | DRIVE_STOP_MECH | -- | 10.0 s | STATE_OFF | STATE_PREPARE_TO_LAUNCH | STATE_OFF | -- |
...
| 8 | DRIVE_STOP_MECH | -- | 10.0 s | STATE_OFF | STATE_PREPARE_TO_LAUNCH | STATE_OFF | -- |

## Trajectory Details

### All Trajectories Overview

<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_all_traj.svg" alt="All trajectories for BlueBOutKeep3NDepNOutScoreNCliWin" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step1_BlueMRDrop3_Init.svg" alt="Trajectory BlueMRDrop3_Init" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step2_BlueMRDrop3_A.svg" alt="Trajectory BlueMRDrop3_A" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step3_BlueMRDrop3_C.svg" alt="Trajectory BlueMRDrop3_C" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step5_BlueMRDrop3_D.svg" alt="Trajectory BlueMRDrop3_D" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step6_BlueMRDrop3_E.svg" alt="Trajectory BlueMRDrop3_E" width="900"/>
...
<img src="svg/traj/BlueBOutKeep3NDepNOutScoreNCliWin_step7_BlueMRDrop3_F.svg" alt="Trajectory BlueMRDrop3_F" width="900"/>

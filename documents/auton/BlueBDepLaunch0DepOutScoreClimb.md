# Auton: BlueBDepLaunch0DepOutScoreClimb

> Auto-generated from [`src/main/deploy/auton/BlueBDepLaunch0DepOutScoreClimb.xml`](../../src/main/deploy/auton/BlueBDepLaunch0DepOutScoreClimb.xml).  
...
stateDiagram-v2
    ...
    Step4 --> Step5: "intake=INTAKE | zones=LaunchZone OutpostZone DRIVE_TO_OUTPOST"
...
| 2 | TRAJECTORY_DRIVE | [BlueMLDepotOutpost_A](../../src/main/deploy/choreo/BlueMLDepotOutpost_A.traj) | 3.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | BlueLaunchZone, BlueDepotZone |
| 3 | TRAJECTORY_DRIVE | [BlueMLDepotOutpost_B](../../src/main/deploy/choreo/BlueMLDepotOutpost_B.traj) | 3.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | BlueLaunchZone |
| 4 | TRAJECTORY_DRIVE | [BlueMLDepotOutpost_C](../../src/main/deploy/choreo/BlueMLDepotOutpost_C.traj) | 3.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | BlueLaunchZone, BlueOutpostZone |
...
<img src="svg/traj/BlueBDepLaunch0DepOutScoreClimb_all_traj.svg" alt="All trajectories for BlueBDepLaunch0DepOutScoreClimb" width="900"/>

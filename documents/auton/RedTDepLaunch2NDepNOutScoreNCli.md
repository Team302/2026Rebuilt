...
| 2 | TRAJECTORY_DRIVE | BlueLeftBumpNZNZ_A | 2.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | RedLeftBumpZone |
| 3 | TRAJECTORY_DRIVE | LeftToRightNZ | 5.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | RedRightBumpZone |
| 4 | TRAJECTORY_DRIVE | BlueLeftBumpNZNZ_C | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedLaunchZone |
| 5 | TRAJECTORY_DRIVE | RightToLeftNZ | 5.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | RedLeftBumpZone |
| 6 | TRAJECTORY_DRIVE | BlueLeftBumpNZNZ_D | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedLaunchZone |

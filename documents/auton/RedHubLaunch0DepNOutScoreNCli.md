# Auton: RedHubLaunch0DepNOutScoreNCli

> Auto-generated from [`src/main/deploy/auton/RedHubLaunch0DepNOutScoreNCli.xml`](../../src/main/deploy/auton/RedHubLaunch0DepNOutScoreNCli.xml).  
...
<img src="svg/traj/RedHubLaunch0DepNOutScoreNCli_all_traj.svg" alt="All trajectories for RedHubLaunch0DepNOutScoreNCli" width="900"/>
...
<img src="svg/traj/RedHubLaunch0DepNOutScoreNCli_step1_Depot1.svg" alt="Trajectory Depot1" width="900"/>

| # | X (m) | Y (m) | Heading (deg) |
|---|-------|-------|---------------|
| 1 | 12.965 | 4.147 | 180.0 |
| 2 | 13.452 | 4.125 | 0.0 |
...
<img src="svg/traj/RedHubLaunch0DepNOutScoreNCli_step4_Depot2.svg" alt="Trajectory Depot2" width="900"/>

| # | X (m) | Y (m) | Heading (deg) |
|---|-------|-------|---------------|
| 1 | 13.452 | 4.125 | 0.0 |
| 2 | 14.286 | 3.205 | 180.0 |
| 3 | 14.892 | 2.306 | 180.0 |
| 4 | 15.975 | 2.176 | 0.0 |

...
|------|-----------|------------|---------|--------|----------|---------|-------|
| 1 | TRAJECTORY_DRIVE | BlueLDepotOutpost_A | 3.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedLaunchZone |
| 2 | TRAJECTORY_DRIVE | BlueLDepotOutpost_B | 4.0 s | STATE_INTAKE | STATE_IDLE | STATE_OFF | RedLaunchZone, RedOutpostZone |

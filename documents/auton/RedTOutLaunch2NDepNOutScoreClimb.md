...
|------|-----------|------------|---------|--------|----------|---------|-------|
| 1 | TRAJECTORY_DRIVE | BlueRightBumpNZNZ_A | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedRightBumpZone |
| 2 | TRAJECTORY_DRIVE | RightToLeftNZ | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedLeftBumpZone |
| 3 | TRAJECTORY_DRIVE | BlueRightBumpNZNZ_C | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedLeftBumpZone |
| 4 | TRAJECTORY_DRIVE | LeftToRightNZ | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | ? |
| 5 | TRAJECTORY_DRIVE | BlueRightBumpNZNZ_E | 5.0 s | STATE_OFF | STATE_IDLE | STATE_OFF | RedRightBumpZone |

...
- **Description:** This utility is specifically designed for calculating target positions for the launcher in the 2026 season. It leverages the field constants and alliance zone information to determine optimal targeting.
- **Dependencies:** 
  - `auton/AllianceZoneManager.h`
  - `fielddata/FieldConstants.h`

### TargetCalculator
- **File:** `src/main/cpp/utils/TargetCalculator.h`
- **Description:** The base class for target calculation, providing fundamental methods and properties that can be extended for specific target calculation strategies.
- **Dependencies:** 
  - `chassis/ChassisConfigMgr.h`
  - `chassis/generated/CommandSwerveDrivetrain.h`
```

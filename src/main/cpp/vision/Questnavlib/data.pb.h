...
PROTOBUF_NAMESPACE_OPEN
template <>
::questnav::protos::data::ProtobufQuestNavDeviceData *Arena::CreateMaybeMessage<::questnav::protos::data::ProtobufQuestNavDeviceData>(Arena *);
template <>
::questnav::protos::data::ProtobufQuestNavFrameData *Arena::CreateMaybeMessage<::questnav::protos::data::ProtobufQuestNavFrameData>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace questnav
{
  namespace protos
  {
    namespace data
    {
      ...
      class ProtobufQuestNavFrameData final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:questnav.protos.data.ProtobufQuestNavFrameData) */
      {
      public:
      ...
      class ProtobufQuestNavDeviceData final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:questnav.protos.data.ProtobufQuestNavDeviceData) */
      {
      public:

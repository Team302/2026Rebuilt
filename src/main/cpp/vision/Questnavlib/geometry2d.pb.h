...
PROTOBUF_NAMESPACE_OPEN
template <>
::wpi::proto::ProtobufEllipse2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufEllipse2d>(Arena *);
template <>
::wpi::proto::ProtobufPose2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufPose2d>(Arena *);
template <>
::wpi::proto::ProtobufRectangle2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufRectangle2d>(Arena *);
template <>
::wpi::proto::ProtobufRotation2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufRotation2d>(Arena *);
template <>
::wpi::proto::ProtobufTransform2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTransform2d>(Arena *);
template <>
::wpi::proto::ProtobufTranslation2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTranslation2d>(Arena *);
template <>
::wpi::proto::ProtobufTwist2d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTwist2d>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace wpi
{
  namespace proto
  {
    ...
    class ProtobufTranslation2d final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wpi.proto.ProtobufTranslation2d) */
    {
    public:

...
PROTOBUF_NAMESPACE_OPEN
template <>
::wpi::proto::ProtobufPose3d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufPose3d>(Arena *);
template <>
::wpi::proto::ProtobufQuaternion *Arena::CreateMaybeMessage<::wpi::proto::ProtobufQuaternion>(Arena *);
template <>
::wpi::proto::ProtobufRotation3d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufRotation3d>(Arena *);
template <>
::wpi::proto::ProtobufTransform3d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTransform3d>(Arena *);
template <>
::wpi::proto::ProtobufTranslation3d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTranslation3d>(Arena *);
template <>
::wpi::proto::ProtobufTwist3d *Arena::CreateMaybeMessage<::wpi::proto::ProtobufTwist3d>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace wpi
{
  namespace proto
  {
    ...
    class ProtobufTranslation3d final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wpi.proto.ProtobufTranslation3d) */
    {
    public:
